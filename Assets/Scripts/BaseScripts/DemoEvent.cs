...
/// Note that we inherit from HallucinationEvent and not MonoBehaviour on line 14
...
/// </summary>
public class SwapObjects : HallucinationEvent
{
    ...
    /// PerformHallucinationEvent is a function that you inherit from the Event class
    /// Always make sure to include at the very beginning a call to the version of the function that exists in the base class like on line 30: 'base.PerformHallucinationEvent();'
    /// </summary>
